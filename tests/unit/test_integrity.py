...
class TestIntegrityCheck:
    ...
    def test_integrity_check_all_good(self, test_settings, mocker):
    ...
    def test_integrity_check_with_manifest(self, test_settings, mocker):
    ...
    def test_integrity_check_hash_mismatch(self, test_settings, mocker):
        ...
        # Create a manifest file with different hash
        test_settings.tmp_dir.mkdir(parents=True, exist_ok=True)
        manifest_file = test_settings.tmp_dir / "manifest.csv"
        manifest_file.write_text("wrong_hash,2024/folder/email.eml\n")
    ...
    def test_integrity_check_repair_on_mismatch(self, test_settings, mocker):
        ...
        # Create manifest file with different hash
        test_settings.tmp_dir.mkdir(parents=True, exist_ok=True)
        manifest_file = test_settings.tmp_dir / "manifest.csv"
        manifest_file.write_text("wrong_hash,2024/folder/email.eml\n")
    ...
    def test_integrity_check_no_synced_files(self, test_settings, mocker):
    ...
    def test_integrity_check_verify_disabled(self, test_settings, mocker):
    ...
    def test_integrity_check_with_remote_hash(self, test_settings, mocker):
        """Test integrity check using remote hash verification."""
        # No manifest file exists
        mocker.patch("mailbackup.integrity.rclone_copyto", return_value=Mock(returncode=0))
        mocker.patch("mailbackup.integrity.remote_hash", return_value={"2024/folder/email.eml": "abc123"})
