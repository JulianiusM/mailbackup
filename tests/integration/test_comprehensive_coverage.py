...
class TestUtilsIntegration:
    ...
    def test_atomic_upload_file_copyto_failure(self, tmp_path, mocker):
        ...
        mocker.patch("mailbackup.rclone.rclone_copyto", return_value=Mock(returncode=1))
        mock_delete = mocker.patch("mailbackup.rclone.rclone_deletefile", return_value=Mock(returncode=0))
    ...
    def test_atomic_upload_file_moveto_failure(self, tmp_path, mocker):
        ...
        mocker.patch("mailbackup.rclone.rclone_copyto", return_value=Mock(returncode=0))
        mocker.patch("mailbackup.rclone.rclone_moveto", return_value=Mock(returncode=1))
        mock_delete = mocker.patch("mailbackup.rclone.rclone_deletefile", return_value=Mock(returncode=0))
    ...
    def test_compute_remote_sha256_success(self, test_settings, mocker):
        ...
        mocker.patch("mailbackup.rclone.rclone_cat", return_value=Mock(
            returncode=0,
            stdout="test content"
        ))
    ...
    def test_compute_remote_sha256_exception(self, test_settings, mocker):
        ...
        mocker.patch("mailbackup.rclone.rclone_cat", side_effect=Exception("Failed"))
    ...
    def test_remote_hash_with_hashsum_support(self, test_settings, mocker):
        ...
        mocker.patch("mailbackup.rclone.rclone_hashsum", return_value=Mock(
            returncode=0,
    ...
    def test_remote_hash_fallback_streaming(self, test_settings, mocker):
        ...
        mocker.patch("mailbackup.rclone.rclone_hashsum", return_value=Mock(returncode=1, stdout=""))
        mocker.patch("mailbackup.rclone.rclone_lsjson", return_value=Mock(
            returncode=0,
    ...
    def test_remote_hash_lsjson_failure(self, test_settings, mocker):
        ...
        mocker.patch("mailbackup.rclone.rclone_hashsum", return_value=Mock(returncode=1, stdout=""))
        mocker.patch("mailbackup.rclone.rclone_lsjson", return_value=Mock(returncode=1, stdout=""))
